...
panecho does not checkpoint arbitrary live process state. Ordinary terminals,
tmux, vim, shells, and unsupported terminal apps reopen as normal terminals.
For live detach/reattach across panecho quit, crashes, and updates, opt in to the
