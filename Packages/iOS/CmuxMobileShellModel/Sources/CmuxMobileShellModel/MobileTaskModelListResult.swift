...
public enum MobileTaskModelListError: String, Equatable, Sendable {
    ...
    /// The selected Mac could not answer the catalog request.
...
public struct MobileTaskModelListResult: Equatable, Sendable {
    ...
    /// A provider or host discovery error, when applicable.
    ...
    ///   - error: Provider or host discovery failure, when applicable.
    public init(
