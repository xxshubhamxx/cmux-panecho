...
/// `CMUX_TERMINAL_LIFECYCLE_ID` / `CMUX_SOCKET_PATH` (and legacy tab/panel
...
public struct TerminalSurfaceCmuxContextEnvironment: Equatable, Sendable {
    ...
    /// The process-generation id exported as `CMUX_TERMINAL_LIFECYCLE_ID`.
    ...
    ///   - terminalLifecycleId: The terminal process-generation id.
