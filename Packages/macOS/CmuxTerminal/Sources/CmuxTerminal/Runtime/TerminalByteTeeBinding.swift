...
/// Installs and tears down the mobile PTY byte tee for runtime surfaces.
///
/// Implemented in the app over `MobileTerminalByteTee`; paired iPhones
/// consume the tee'd bytes for grid-parity rendering.
