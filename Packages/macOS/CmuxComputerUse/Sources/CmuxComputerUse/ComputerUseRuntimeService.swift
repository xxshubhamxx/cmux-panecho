...
public final class ComputerUseRuntimeService {
    ...
    ///
    /// - Parameter adoptsBundledHelper: `false` skips looking for the nested helper
    ///   app entirely (Panecho privacy builds; this package cannot see the app's
    ///   `PrivacyMode`, so the host decides).
    public init(
        bundle: Bundle = .main,
        adoptsBundledHelper: Bool = true,
