...
3. Replace the remaining JSON bridge between Swift and the runtime with generated Swift Mojo pipe bindings, keeping the current `OwlFreshSession` and child-interface shape.
