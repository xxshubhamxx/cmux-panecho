...
extension CMUXCLI {
    ...
    static let settingsSchemaURL = "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/web/data/cmux.schema.json"
    ...
    private static let docsReferences: [DocsReference] = [
        DocsReference(
            ...
            rawResources: [
                ...
                DocsResource(label: "cmux skill", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/skills/cmux/SKILL.md"),
            ],
            commands: [
                "cmux settings path",
        ...
        DocsReference(
            ...
            rawResources: [
                DocsResource(label: "shortcut data", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/web/data/cmux-shortcuts.ts"),
                DocsResource(label: "settings schema", url: settingsSchemaURL),
            ],
            commands: [
                "cmux shortcuts",
        ...
        DocsReference(
            ...
            rawResources: [
                DocsResource(label: "CLI contract", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/docs/cli-contract.md"),
                DocsResource(label: "cmux skill", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/skills/cmux/SKILL.md"),
            ],
            commands: [
                "cmux identify --json",
        ...
        DocsReference(
            ...
            rawResources: [
                DocsResource(label: "browser skill", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/skills/cmux-browser/SKILL.md"),
                DocsResource(label: "browser commands", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/skills/cmux-browser/references/commands.md"),
            ],
            commands: [
                "cmux browser --help",
        ...
        DocsReference(
            ...
            rawResources: [
                DocsResource(label: "agent hook docs", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/docs/agent-hooks.md"),
                DocsResource(label: "feed docs", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/docs/feed.md"),
                DocsResource(label: "notifications docs", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/docs/notifications.md"),
            ],
            commands: [
                "cmux hooks setup",
        ...
        DocsReference(
            ...
            rawResources: [
                DocsResource(label: "dock docs", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/docs/dock.md"),
                DocsResource(label: "dock web copy", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/web/messages/en.json"),
            ],
            commands: [
                "cmux docs dock",
                "cmux docs dock --json",
        ...
        DocsReference(
            ...
            rawResources: [
                DocsResource(label: "custom sidebar authoring guide", url: "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/docs/custom-sidebars.md"),
            ],
            commands: [
