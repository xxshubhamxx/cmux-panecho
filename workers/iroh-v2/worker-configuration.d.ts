/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b8d5ca0da4f17050eeed007be0de3b04)
...
interface __BaseEnv_Env {
	...
	AXIOM_DATASET: "iroh-v2";
	AXIOM_INGEST_URL: "https://api.axiom.co/v1/datasets/iroh-v2/ingest";
	SENTRY_ENVIRONMENT: "development" | "staging" | "production" | "local";
	STACK_PROJECT_ID: string;
	STACK_PUBLISHABLE_KEY: string;
	STACK_SERVER_KEY: string;
	API_TICKET_KEYS: string;
	API_TICKET_CURRENT_KEY_ID: string;
	...
	USER_USAGE: DurableObjectNamespace<import("./src/index").UserUsage>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TeamControl" | "UserUsage";
	}
