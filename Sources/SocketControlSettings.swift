...
enum SocketControlMode: String, CaseIterable, Identifiable {
    ...
    var displayName: String {
        ...
        case .cmuxOnly:
            return privacyModeBranded("Panecho processes only", stable: String(localized: "socketControl.cmuxOnly.name", defaultValue: "cmux processes only"))
        case .automation:
    ...
    var description: String {
        ...
        case .cmuxOnly:
            return privacyModeBranded(
                "Only processes started inside Panecho terminals can send commands.",
                stable: String(localized: "socketControl.cmuxOnly.description", defaultValue: "Only processes started inside cmux terminals can send commands.")
            )
        case .automation:
