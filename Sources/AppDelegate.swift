...
final class AppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate, NSMenuItemValidation, NSMenuDelegate, CmuxConfigStoreReloadEnvironment {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        if sentryStartupPolicy.shouldStart && !PrivacyMode.isEnabled {
        ...
        if telemetryEnabled && !PrivacyMode.isEnabled && !isRunningUnderXCTest {
        ...
        // built-in defaults. Panecho privacy mode never fetches them at all.
        if !isRunningUnderXCTest, !PrivacyMode.isEnabled, !ManagedDevicePolicy().isEnforced(.disableTelemetry) {
    ...
    func applicationDidBecomeActive(_ notification: Notification) {
        ...
        if !PrivacyMode.isEnabled && TelemetrySettings.enabledForCurrentLaunch && !isRunningUnderXCTestCached {
    ...
    func performCloudVMAction(
        ...
        guard PrivacyMode.defaultCloudVMEnabled else {
            NSSound.beep()
            return false
        }
