...
final class CmuxSettingsFileStore {
    ...
    static let schemaURLString = "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.20.1/web/data/cmux.schema.json"
    private static let legacySchemaURLString = "https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.20.1/web/data/cmux-settings.schema.json"
